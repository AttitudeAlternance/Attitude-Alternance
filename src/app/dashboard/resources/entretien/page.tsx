...
export default function InterviewGuidePage() {
  return (
    <div>
      <Link href="/dashboard/resources" className="text-sm font-medium text-primary hover:underline">
        ← Retour aux ressources
      </Link>

      <div className="mb-6 mt-3">
        <h1 className="font-display text-2xl font-bold text-ink">Préparer son entretien d&apos;alternance</h1>
